...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
    ...
    {
        VertexFormat(glm::vec3(3, 0,  0), glm::vec3(1, 0, 1)),
        VertexFormat(glm::vec3(1, 2,  0), glm::vec3(1, 0, 1)),
        VertexFormat(glm::vec3(0, 1,  4), glm::vec3(1, 0, 1)),

    };
    vector<unsigned int> indices2 =
    {   
        //clockwise pentru vizibil, counter-clockwise pentru invizibil
        2,3,1,
        2,0,3,
        2,1,0,
        3,1,0,
    ...
    vector<VertexFormat> vertices3
    {
        ...
        VertexFormat(glm::vec3(2, 0, 2), glm::vec3(1, 1, 0)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.50f));
    ...
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 1), glm::vec3(0.50f));
